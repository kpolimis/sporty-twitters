...
parser = argparse.ArgumentParser(description='From a list of users L for which the friends have been collected using process_user.py, this script outputs a list of Twitter users randomly selected amongst the friends of L users and that is the same size of L.')
...
def sportusers2friends(input_file, output_file, directory):
